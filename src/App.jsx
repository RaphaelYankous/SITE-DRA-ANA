    ...
    <div className="min-h-screen bg-[#F7FBF9] text-slate-800 font-sans selection:bg-[#C5A059]/20 scroll-smooth">
        ...
        <nav className="container mx-auto px-6 py-4 flex justify-between items-center text-left">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] tracking-[0.3em] uppercase text-[#C5A059] font-bold mt-1">Saúde Mental</span>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6 flex flex-col lg:flex-row items-center gap-20">
          <motion.div initial="hidden" animate="visible" variants={fadeInUp} className="lg:w-1/2 space-y-10 text-left">
            ...
            <p className="text-xl text-slate-600 max-w-lg leading-relaxed font-light border-l-4 border-[#C5A059] pl-8 italic">
              Acompanhemento focado em saúde mental pautada pelo rigor científico e pelo acolhimento necessário para sua jornada de equilíbrio emocional.
            </p>
            <div className="flex flex-wrap gap-6 pt-4 text-left">
      ...
      <section className="py-24 bg-white border-y border-slate-50">
        <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12 text-center font-light">
          <Feature title="Acolhimento Humano" text="Escuta ativa e empática em um espaço livre de julgamentos para sua história." />
          <Feature title="Base Científica" text="Tratamentos fundamentados nas diretrizes internacionais de neurociência e saúde mental." />
          <Feature title="Sigilo Absoluto" text="Ética inegociável em todos os processos de atendimento presencial ou telemedicina." />
        </div>
      </section>
      ...
      {/* 4. TRATAMENTOS ESPECIALIZADOS */}
      <section id="tratamentos" className="py-40 bg-white text-left">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mb-24">
            <h2 className="text-4xl lg:text-5xl font-serif text-slate-900 mb-6 italic tracking-tight">Tratamentos Especializados</h2>
            <p className="text-slate-500 font-light text-xl">Uma abordagem personalizada para as complexidades da mente humana.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <TreatmentCard title="Ansiedade e Pânico" desc="Manejo clínico focado na redução dos sintomas físicos e emocionais, permitindo que você retome o controle das suas atividades diárias." />
            <TreatmentCard title="Depressão e Humor" desc="Acompanhamento detalhado para quadros de desânimo e alterações de humor, visando a remissão total dos sintomas." />
            <TreatmentCard title="Burnout e Estresse" desc="Estratégias específicas para o esgotamento mental causado pelo ambiente de trabalho, focando em recuperação e limites saudáveis." />
            <TreatmentCard title="Telemedicina" desc="Atendimento seguro e ético através de plataformas criptografadas, garantindo suporte onde quer que você esteja." />
          </div>
        </div>
      </section>

      {/* 5. METODOLOGIA - CORRIGIDO (Verde Claro e Colorido) */}
      <section id="metodologia" className="py-32 bg-[#F0F7F4]">
        <div className="container mx-auto px-6 grid md:grid-cols-2 gap-20 items-center text-left">
          <div className="space-y-12">
            <h2 className="text-4xl font-serif italic text-slate-900 leading-tight tracking-tight">Uma prática baseada na responsabilidade</h2>
            <div className="space-y-10">
              <MethodItem num="01" title="Acolhimento Inicial" desc="Escuta qualificada para compreender a sua história e necessidades clínicas imediatas." />
              <MethodItem num="02" title="Planeamento Terapêutico" desc="Definição conjunta de metas, intervenções e orientações práticas para o estilo de vida." />
              <MethodItem num="03" title="Monitoramento Contínuo" desc="Suporte assistido entre as consultas para garantir a evolução e segurança do paciente." />
            </div>
          </div>
      ...
      <section id="duvidas" className="py-40 bg-white text-left">
        <div className="container mx-auto px-6 max-w-4xl">
          <h2 className="text-4xl font-serif text-center mb-16 italic tracking-tight text-slate-900">Dúvidas Frequentes</h2>
          <div className="space-y-4">
             ...
             <Accordion title="O atendimento online é seguro?">
                Sim. Utilizamos plataformas criptografadas autorizadas pelo CFM para garantir total sigilo e a mesma qualidade técnica do presencial.
             </Accordion>
             <Accordion title="Preciso tomar medicação obrigatoriamente?">
                Não. A medicação é uma ferramenta discutida em conjunto e utilizada apenas quando há necessidade clínica comprovada.
             </Accordion>
          </div>
        </div>
      </section>
      ...
      <footer id="contato" className="py-24 bg-[#F0F7F4] border-t border-[#D1E8E2]">
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-start gap-12 text-left">
          ...
          <div className="space-y-6">
            <p className="font-bold text-xs uppercase tracking-[0.3em] text-[#C5A059]">Contacto</p>
